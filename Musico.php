...
echo "<meta http-equiv='Refresh' content='5;url=index.php'>";
	...
	$ciudad = $_POST['ciudad'];
	$correo = $_POST['correo_musico'];
	$telefono = $_POST['telefono'];
	$direccion = $_POST['direccion_musico'];
	$fecha_nacimiento = date('Y/m/d', strtotime($_POST['fecha_nacimiento']));
	$genero_musico = $_POST['genero_musical'];
	$ciudad_musico = $_POST['ciudad'];
	...
	$query5 = "insert into Usuario(nombre, contrasenya, correo_usuario, telefono_usuario, fecha_nacimiento, direccion_usuario, codigo_ciudad, 			       			      codigo_genero, tipo, imagen_perfil) 	
	values ('$nombre', '$password_encriptado', '$correo', '$telefono', '$fecha_nacimiento', '$direccion', '$ciudad_musico', '$genero_musico', 2, 'imagenes/perfil_predefinido.jpg');";
