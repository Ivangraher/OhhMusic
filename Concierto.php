...
echo "<meta http-equiv='Refresh' content='5;url=index.php'>";
	...
	$codigo_genero = $_POST['genero_musical'];
	
		
	$query5 = "insert into Concierto(nombre_concierto, fecha_concierto, codigo_genero, estado_concierto, codigo_musico, codigo_usuario, codigo_local) 
	values ('$nombre', '$fecha_concierto', '$codigo_genero', 1, 0, $id, $id);";
	$resultado5=mysqli_query($con, $query5);
	echo "El concierto ha sido creado correctamente";
