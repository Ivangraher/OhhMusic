...
echo "<meta http-equiv='Refresh' content='5;url=index.php'>";
				...
				$query="SELECT * FROM Usuario u, Genero g WHERE u.codigo_genero=g.codigo_genero and u.tipo=2";
				$db->executer($query);
				$result=$db->getResultados($query);
				echo "<table border=1>";
				echo "<tr><td>Nombre del musico</td><td>Genero del musico</td></tr>";
					foreach($result as $musicos){
						extract($musicos);
						...
						echo "<td><a href='VotacionesMusicos.php?codigo=$codigo_usuario'>Votar musico</a></td>";
						}
					}
					echo "</tr>";
