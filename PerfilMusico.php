...
<html>
    <head><meta http-equiv="Content-Type" content="text/html; charset=windows-1252">
        <title>Perfil-Musico</title>
        
        <meta name="viewport" content="width=device-width, initial-scale=1.0">
        <link rel="stylesheet" href="CSS/basic.css"/>
		<link rel="stylesheet" href="CSS/Perfil_Musico.css"/>
...
$query="select u.nombre, c.nombre_ciudad, u.correo_usuario, u.telefono_usuario, u.direccion_usuario, u.fecha_nacimiento, g.nombre_genero, u.imagen_perfil 
...
echo "Nombre del musico: $nombre
</br>
Fecha de nacimiento: $fecha_nacimiento
</br>
Correo electronico: $correo_usuario
</br>
Telefono del musico: $telefono_usuario
</br>
Ciudad: $nombre_ciudad
</br>
Genero del  musico: $nombre_genero
</br>";
echo "<div id='image'>";
                                ...
                                <tbody>
                                    <tr>
                                      <td>
                                            ...
                                            <span class="dreta">
                                              <a class='btn' href='PaginacionConcierto.php'>Buscar conciertos</a>
                                            </span>
                                    ...
                                    <tr><td>
                                        <span class="dreta">
					<a class='btn' href='MusicoCandidaturas.php'>Ver mis candidaturas</a>
                                         </span>
