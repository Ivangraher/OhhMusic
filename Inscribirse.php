...
echo "Felicidades, te acabas de inscribir en el concierto.";
$query = "insert into Subasta (codigo_usuario, codigo_concierto, estado)
values ($codigo_usuario, $codigo_concierto, 1);";
$resultado = mysqli_query($con, $query);
echo "<meta http-equiv='Refresh' content='3;url=PerfilMusico.php'>";
}
mysqli_close($con);
?>
