...
<html>
    <head><meta http-equiv="Content-Type" content="text/html; charset=gb18030">
        <title>Registro-Musico</title>
        
        <meta name="viewport" content="width=device-width, initial-scale=1.0">
        <link rel="stylesheet" href="CSS/basic.css"/>
		<link rel="stylesheet" href="CSS/Registro_Musico.css"/>
...
<br>
<div id='Registro_Musico'>
<?php
$con = mysqli_connect("$server", "$user", "$password", "$basededatos")
	or die("No se ha podido conectar con la base de datos.");
		 
echo "<form method='post' action='Musico.php'>
	Nombre:<input type='text' name='nombre_musico'/><br/>";
	if(isset($_SESSION['error'])){
	...
	echo "<br/>";
	echo "Correo:<input type='text' name='correo_musico'/><br/>";
	echo "<br/>";
	if(isset($_SESSION['error'])){
	...
	<br/>
	Direccion:<input type='text' name='direccion_musico'/><br/>
	<br/>
