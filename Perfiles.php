...
if($tipo==1){
$nombre = $_POST['nuevo_nombre_usu'];
$direccion = $_POST['nueva_direccion_usu'];
$correo = $_POST['nuevo_correo_usu'];
$telefono = $_POST['nuevo_telefono_usu'];
$genero_local = $_POST['nuevo_genero_musical'];
$query="update Usuario set nombre='$nombre', correo_usuario='$correo', telefono_usuario=$telefono, direccion_usuario='$direccion', 
codigo_genero=$genero_local where codigo_usuario=$id;";
$resultado = mysqli_query($con, $query);
echo "Tu perfil ha sido modificado correctamente";
echo "<meta http-equiv='Refresh' content='5;url=PerfilLocal.php'>";
}
...
$resultado = mysqli_query($con, $query);
echo "Tu perfil ha sido modificado correctamente";
echo "<meta http-equiv='Refresh' content='5;url=PerfilMusico.php'>";
}

if($tipo==3){
$nombre = $_POST['nuevo_nombre_usu'];
$correo = $_POST['nuevo_correo_usu'];
$query="update Usuario set nombre='$nombre', correo_usuario='$correo' where codigo_usuario=$id;";
$resultado = mysqli_query($con, $query);
echo "Tu perfil ha sido modificado correctamente";
echo "<meta http-equiv='Refresh' content='5;url=PerfilFan.php'>";
}
